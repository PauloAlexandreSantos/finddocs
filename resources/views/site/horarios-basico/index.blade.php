...
@section('titulo', 'Avea - Horário Primário')
@section('conteudo')
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h1 class="text-white">Horário / Ensino Primário</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="" class="btn btn-primary btn-filled" target="_blank" ><i class="icon icon-download "></i>  TRANSFERIR HORÁRIO</a>
                    </div>
